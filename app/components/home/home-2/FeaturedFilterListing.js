  ...
  return (
    <div className="popular_listing_sliders">
      ...
      <div className="nav nav-tabs  justify-content-center ">
        ...
        <button
          className={filter === "compact" ? "active nav-link" : "nav-link"}
        ...
        <button
          className={filter === "suv" ? "active nav-link" : "nav-link"}
          onClick={() => setFilter("suv")}
        >
          SUV
        </button>
        <button
          className={filter === "sedan" ? "active nav-link" : "nav-link"}
            ...
            <div className="car-listing list_style">
              ...
              <div className="details">
                <div className="wrapper">
                  ...
                  <h5 className="price">₹ {listing.price} Lakh</h5>
