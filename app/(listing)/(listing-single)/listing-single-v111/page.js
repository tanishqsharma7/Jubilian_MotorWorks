...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v111/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview111";
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title">{listingCar[10].title}</h2>
                  {/* <p className="para">
              ...
              <div className="single_page_heading_content text-start text-lg-end">
                ...
                <div className="price_content">
                  <div className="price mt60 mb10 mt10-md">
                    <h3>₹ {listingCar[10].price} Lakh</h3>
                  </div>
                </div>
              </div>
            </div>
