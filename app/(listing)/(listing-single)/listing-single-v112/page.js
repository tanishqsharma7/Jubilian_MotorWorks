...
import ProductGallery from "@/app/components/listing/listing-single/listing-single-v112/ProductGallery";
import Overview from "@/app/components/listing/listing-single/Overview112";
...
export const metadata = {
  title: "Jubilian MotorWorks | Used Auto Dealer",
};
            ...
            <div className="col-lg-7 col-xl-8">
              <div className="single_page_heading_content">
                <div className="car_single_content_wrapper">
                  ...
                  <h2 className="title">{listingCar[11].title}</h2>
                  {/* <p className="para">
              ...
              <div className="single_page_heading_content text-start text-lg-end">
                ...
                <div className="price_content">
                  <div className="price mt60 mb10 mt10-md">
                    <h3>₹ {listingCar[11].price} Lakh</h3>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="row">
              ...
              <div className="user_profile_location">
                ...
                <div className="upl_content d-block d-md-flex">
                  <p className="float-start fn-sm mb20-sm">
                    ...
                    JMD Empire Square, MG Road, Gurgaon - 122001
                  </p>
            ...
            <div className="col-lg-4 col-xl-4">
              ...
              <div className="sidebar_seller_contact">
                <SellerDetail />
                <h4 className="mb30">Contact Us</h4>
                <ContactSeller />
              </div>
